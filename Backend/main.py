...
app.add_middleware(
    ...
    allow_origins=[
        ...
        # "https://yourdomain.com"  # Deployed frontend domain
    ], 
...
async def ask_question(body: QuestionRequest):
    ...
    except ValueError: # To handle if database is not found (this would create a new one)
    ...
    llm = ChatOllama(
        ...
        keep_alive=0,  # Unloads from RAM/VRAM immediately after invocation
        temperature=0.3
    )
